...
def main():
 ...
 p.add_argument('--trigger',default='matched',help='matched, all, or a trigger ID')
 p.add_argument('--random-flips',action='store_true')
 p.add_argument('--relative-variants',action='store_true')
 p.add_argument('--device',default='cpu')
 p.add_argument('--batch-size',type=int,default=128)
 p.add_argument('--threads',type=int,default=4)
 p.add_argument('--limit',type=int,help='Optional small functional check; omit for full test set')
